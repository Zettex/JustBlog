...
namespace JustBlog
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // 404 page
            var style404 = new StyleBundle("~/Scripts/404/css").Include("~/Scripts/404/css/style.css");
            bundles.Add(style404);

            var eyes404 = new ScriptBundle("~/Scripts/404/js").Include("~/Scripts/404/js/eyes.js");
            bundles.Add(eyes404);
